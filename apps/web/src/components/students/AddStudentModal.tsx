...
export function AddStudentModal({ gymId, onClose, onCreated }: AddStudentModalProps) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await createStudent(gymId, input)
      ...
      >
        <header className="student-modal-header">
          <div>
            ...
            <h2 id="student-add-modal-title">Novo aluno</h2>

            <p>Cadastre os dados operacionais do aluno.</p>
          </div>
        ...
        >
          ...
          {error ? (
            <div className="student-form-error" role="alert" data-testid="student-add-error">
              {error}
            </div>
          ) : null}
