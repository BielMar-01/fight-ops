    ...
    <div className="site-shell">
      ...
      <header className="site-header">
        <div className="site-container header-content">
          <Link to="/" className="brand" data-testid="public-logo-link" onClick={closeMobileMenu}>
            {settings.logoUrl ? (
              <img src={settings.logoUrl} alt={settings.siteName} className="brand-logo" />
            ) : (
              <>
          ...
          <div className="header-actions">
            <Link to="/login" className="button button-ghost" data-testid="public-login-link">
              Entrar
            </Link>
        ...
        <div
          ...
          className={mobileMenuOpen ? 'mobile-navigation open' : 'mobile-navigation'}
        >
          <nav className="site-container mobile-navigation-content" aria-label="Navegação mobile">
            ...
            <div className="mobile-navigation-actions">
              ...
              <Link to="/register" className="button button-primary" onClick={closeMobileMenu}>
                Começar agora
              </Link>
            </div>
          </nav>
        ...
        <div className="site-container footer-grid">
          <div>
            ...
            <p className="footer-description">
              Gestão completa para academias, centros de treinamento, professores e alunos.
            </p>
          </div>
