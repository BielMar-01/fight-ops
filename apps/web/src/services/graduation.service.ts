...
function buildGraduationsQuery(params: ListGraduationsParams = {}) {
...
export async function listGraduations(
  ...
  const query = buildGraduationsQuery(params)
...
export async function createGraduation(
  ...
  return apiRequest<GraduationResponse>(`/gyms/${gymId}/modalities/${modalityId}/graduations`, {
    method: 'POST',
