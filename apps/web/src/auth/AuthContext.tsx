...
import { getAuthenticatedUser, logoutSession, refreshSession } from '../services/auth.service'

import type { AuthenticatedUser, AuthUser } from '../types/auth'

interface AuthContextValue {
  user: AuthenticatedUser | AuthUser | null
...
export function AuthProvider({ children }: AuthProviderProps) {
  const [user, setUser] = useState<AuthenticatedUser | AuthUser | null>(null)
