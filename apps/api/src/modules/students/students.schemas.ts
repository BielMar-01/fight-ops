...
export const studentParamsSchema = z.object({
  ...
  studentId: z.string().uuid('Identificador do aluno inválido.'),
})
...
export const listStudentsQuerySchema = z.object({
  ...
  search: z.string().trim().max(150, 'A busca deve possuir no máximo 150 caracteres.').optional(),
...
export const createStudentBodySchema = z.object({
  name: z
    .string()
    .trim()
    .min(2, 'O nome do aluno deve possuir pelo menos 2 caracteres.')
    .max(150, 'O nome do aluno deve possuir no máximo 150 caracteres.'),
  ...
  emergencyContact: z
    .string()
    .trim()
    .max(150, 'O contato de emergência deve possuir no máximo 150 caracteres.')
    .optional()
    .nullable(),
...
export const updateStudentStatusBodySchema = z.object({
  active: z.boolean(),
})
